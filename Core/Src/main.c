...
int main(void)
{
  ...
  userTaskHandle = osThreadNew(userTaskCb, NULL, &userTask_attributes);
...
/* USER CODE BEGIN Header_userTaskCb */
/**
 * @brief Function implementing the userTask thread.
 * @param argument: Not used
 * @retval None
 */
/* USER CODE END Header_userTaskCb */
void userTaskCb(void *argument)
{
  /* USER CODE BEGIN userTaskCb */
  /* Infinite loop */
  for (;;)
  {
    osDelay(1000);
